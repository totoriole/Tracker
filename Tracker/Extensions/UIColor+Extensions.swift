...
extension UIColor {
    ...
    static let blueBground = UIColor(named: "BlueBackground") ?? .blue
    static let blackday = UIColor(named: "Black Day") ?? .black
    static let greybackgroundElement = UIColor(named: "BackgroundElementsGrey") ?? .lightGray
    static let whiteday = UIColor(named: "White Day") ?? .white
    static let greyYP = UIColor(named: "Grey") ?? .gray
    static let redtext = UIColor(named: "Red text") ?? .red
    static let backgroundday = UIColor(named: "Background Day") ?? .lightGray
    static let backgroundnight = UIColor(named: "Background Night") ?? .darkGray
